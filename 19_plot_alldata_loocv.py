"""
Script 19: Plot All Data LOOCV results for all 4 models
"""
...
def main():
    print("="*60)
    print("Script 19: Plotting All Data LOOCV Results")
    print("="*60)
    ...
    for idx, (model, model_name) in enumerate(zip(models, model_names)):
        data = np.load(f'alldata_loocv_{model}_results.npz', allow_pickle=True)
    ...
    plt.tight_layout()
    plt.savefig('alldata_loocv_comparison.png', dpi=300, bbox_inches='tight')
    print(f"\nPlot saved to: alldata_loocv_comparison.png")
